          ...
          <Accordion type="single" collapsible className="w-full">
            {[
              ...
              },
              {
                ...
                answer:
                  "O Plano Básico (R$ 7,90) oferece uma página com validade de 1 ano, 1 foto e um contador dinâmico. O Plano Premium (R$ 9,90) oferece uma página com validade permanente, até 5 fotos, contador em tempo real e a possibilidade de adicionar uma música do YouTube.",
              },
              {
