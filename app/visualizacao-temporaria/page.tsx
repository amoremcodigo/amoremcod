...
export default function VisualizacaoTemporaria() {
  ...
  // Componente da caixa flutuante para reutilização
  const FloatingBox = () => (
    <div className="bg-black/90 backdrop-blur-md border border-purple-500 rounded-xl p-6 max-w-xs mx-4 shadow-2xl">
      <div className="text-center">
        ...
        <h2 className="text-xl font-bold mb-3 gradient-text">Sua página personalizada com QR Code já foi criada!</h2>
        <p className="text-gray-300 mb-4">Libere o acesso completo automaticamente ao finalizar o pagamento.</p>
        <Button onClick={redirectToCheckout} className="w-full gradient-bg text-white font-medium py-2 px-4 rounded-md">
          Finalizar pagamento
        </Button>
      </div>
    </div>
