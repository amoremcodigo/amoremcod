import { Heart, QrCode, ImageIcon, Clock, ExternalLink, ArrowDown } from "lucide-react"
    ...
    <section className="w-full py-16 md:py-20" id="como-funciona">
      <div className="container px-4 md:px-6">
        ...
        <div className="flex flex-col items-center justify-center mt-16 mb-16">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-4 text-center max-w-3xl">
