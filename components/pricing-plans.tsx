          ...
          {[
            {
              ...
              features: [
                ...
                { text: "Nomes", included: true },
                { text: "Mensagem personalizada", included: true },
                { text: "Data de início", included: true },
                { text: "QR Code exclusivo", included: true },
                { text: "Fundo dinâmico", included: true },
                { text: "URL do site personalizada", included: true },
                { text: "Atualizações no site", included: true },
            ...
            },
            {
              ...
              features: [
                { text: "Validade 1 ano", included: true },
                ...
                { text: "Fundo dinâmico", included: false },
                { text: "URL do site personalizada", included: false },
                { text: "Atualizações no site", included: false },
                { text: "Suporte 24 horas", included: false },
              ],
              popular: false,
              id: "basic",
            },
